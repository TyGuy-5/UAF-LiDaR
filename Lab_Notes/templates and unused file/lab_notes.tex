...
\newcommand{\workingDate}{\textsc{June $|$ 2026}}
\newcommand{\userName}{Tyler Celotta}
\newcommand{\institution}{University of Alaska Fairbanks}
...
\hypersetup{
    ...
    pdftitle={Lab notes 2026},     % document title
    pdfauthor={Tyler Celotta},         % author name
