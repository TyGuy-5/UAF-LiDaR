...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Decided by avalible materials, manufacturing capabilities and cost. \footnote{Each crystal has an associated pump acceptance bandwidth $\(\Delta \lambda \approx \frac{0.44 \lambda}{L \vert{}n_z'(\lambda) - 0.5n_z'(\lambda/2)\vert{}}\) $which is inversely dependent on length, so crystal length is an important factor when choosing a crystal. This acceptance bandwidth is due to the group velocity mismatch between the interacting waves. For narrowband CW sources our longer crystal lengths, at 20 to 40mm, should give best efficiency. However, for pulsed sources, a long crystal can have a negative effect if the pump bandwidth is much broader than the crystal acceptance bandwidth. For nanosecond pulses, we typically recommend 10mm lengths and our shortest lengths at 0.5 to 1mm are ideal for femtosecond pulse systems. For SHG of femtosecond pulses, if the pump bandwidth is significantly wider than the acceptance bandwidth, it is still possible to achieve high conversion efficiency. The pump frequencies outside of the acceptance bandwidth can still contribute to the conversion efficiency via sum frequency generation, essentially squeezing the broadband pump into a relatively narrower-band SHG pulse.}
    \end{enumerate}
...
interms of efficancy check inbetween 2.81 and 1
\section{Error Analysis}
\begin{itemize}
    \item Uncertainty in $\omega_{01}$ from divergence measurement: $\pm X\%$
    \item Tolerance on lens placement $d_1$: $\pm 1$\,mm leads to waist change of …
    \item Total uncertainty in achieved $\omega_{02}$: $\pm Y\,\mu$m
\end{itemize}
\newpage
\section{Operating Instructions}
\subsection{Prerequisites/Saftey}
\begin{itemize}
...
\begin{enumerate}
    \item Verify collimator output is centered on iris.
    \item Place focusing lens at distance $d_1$ (see Sec.\,\ref{sec:lens}).
    \item …
    \item Use IR viewer/detector card to check that beam is not clipped by the crystal housing.
\end{enumerate}
...
\textbf{Part Num} & \textbf{Specifications} & \textbf{Description} \\
\midrule
\endfirsthead
...
\midrule
\multicolumn{3}{@{}l}{\textbf{Edmund Industrial Optics}} \\
\midrule
DCX 12 & $\varnothing 1/2^{\prime\prime}$ & Bi-Convex Lens \\  
DCX 24 & $\varnothing 1/2^{\prime\prime}$ & Bi-Convex Lens \\  
DCX 36 & $\varnothing 1/2^{\prime\prime}$ & Bi-Convex Lens \\  
DCX 48 & $\varnothing 1/2^{\prime\prime}$ & Bi-Convex Lens \\  
DCX 60 & $\varnothing 1/2^{\prime\prime}$ & Bi-Convex Lens \\  
PCX 12 & $\varnothing 1/2^{\prime\prime}$ & Plano-Convex Lens \\  
PCX 24 & $\varnothing 1/2^{\prime\prime}$ & Plano-Convex Lens \\  
PCX 36 & $\varnothing 1/2^{\prime\prime}$ & Plano-Convex Lens \\  
PCX 48 & $\varnothing 1/2^{\prime\prime}$ & Plano-Convex Lens \\  
PCX 60 & $\varnothing 1/2^{\prime\prime}$ & Plano-Convex Lens \\  
PCV 12 & $\varnothing 1/2^{\prime\prime}$ & Plano-Concave Lens \\  
PCV 24 & $\varnothing 1/2^{\prime\prime}$ & Plano-Concave Lens \\  
PCV 48 & $\varnothing 1/2^{\prime\prime}$ & Plano-Concave Lens \\  
DCV 12 & $\varnothing 1/2^{\prime\prime}$ & Bi-Concave Lens \\  
EFL 12 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 12) \\  
EFL 15 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 15) \\  
EFL 18 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 18) \\  
EFL 24 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 24) \\  
EFL 30 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 30) \\  
EFL 36 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 36) \\  
EFL 42 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 42) \\  
EFL 48 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 48) \\  
EFL 54 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 54) \\  
EFL 60 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 60) \\  
EFL 72 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 72) \\  
EFL 84 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 84) \\  
EFL 100 & $\varnothing 1/2^{\prime\prime}$ & Lens (EFL = 100) \\  
\midrule
\multicolumn{3}{@{}l}{\textbf{MKS Newport 8-32 Hardware Kit (Item SK-1)}} \\
\midrule
N8S & \#8 & Nut \\  
W8S038 & \#8 & Washer \\  
SH8S025 & $8-32 \times 1/4^{\prime\prime}$ & Cap Screw \\  
SH8S038 & $8-32 \times 3/8^{\prime\prime}$ & Cap Screw \\  
SH8S050 & $8-32 \times 1/2^{\prime\prime}$ & Cap Screw \\  
SH8S075 & $8-32 \times 3/4^{\prime\prime}$ & Cap Screw \\  
SH8S100 & $8-32 \times 1^{\prime\prime}$ & Cap Screw \\  
SH8S125 & $8-32 \times 1\,1/4^{\prime\prime}$ & Cap Screw \\  
SH8S150 & $8-32 \times 1\,1/2^{\prime\prime}$ & Cap Screw \\  
\midrule
\multicolumn{3}{@{}l}{\textbf{General Lab Instruments \& Accessories}} \\
\midrule
KPX058 & $f=88.3$~mm, $\varnothing 12.7$~mm & PCX Lens, BK7 uncoated (Newport) \\  
TC4 & Hex/Allen Keys & Thorlabs Tool Kit \\ 
LB1 & 400~nm -- 2~$\mu$m, 10W & Beam Block (Thorlabs) \\ 
BS040 & 400--700~nm, 12.7~mm & 10:90 Non-Pol Beamsplitter Cube \\
ULM-TILT & --- & Collimator Holder (Newport) \\
MT-RS & --- & Optical Rotation Mount for Polarizer \\
TC-038D & SC2502260152-02 & HCP Crystal Oven Controller \\ 
PM5020 & --- & Dual Channel Optical Power/Energy Meter \\
LDC-3726 & --- & ILX Lightwave Laser Diode Controller \\
TFN-1064.502 & --- & TeraXion Narrowband Tunable Optical Filter \\ 
LDM-4980 & --- & ILX Lightwave Laser Diode Mount \\
ULS2048XL-EVO & --- & Avantes Sensline Spectrometer \\
Keopsys & --- & Lumibird Laser \\ 
VRC2 & 400--640~nm, 800--1700~nm & Detector Card (Thorlabs) \\ 
VRC5 & 700--1400~nm & Detector Card (Thorlabs) \\ 
PM-1064-10 & --- & Optilab RF Phase Modulator \\
SC2502260152-02 & P:3.2 I:33 D:6 & Crystal Oven \\
UP-1A & --- & Newport Universal Post \\
S-2000 Series & --- & Stabilizer Laminar Flow Isolator (Newport) \\
RS2000 & --- & Sealed Hole Table Top (Newport) \\ 
ATS Series & --- & Overhead Table Shelf System (Newport) \\
Lens Tissues & --- & Thorlabs Lens Cleaning Tissues \\ 
Statshield & --- & ESD Garment \\ 
BB-M & --- & Broadband Mirror (Newport) \\ 
HW-KIT6 & --- & Thorlabs Thread Adapter Kit \\ 
HW-KIT2 & $1/4^{\prime\prime}$-20 & Thorlabs Hardware Kit \\ 
\end{longtable}
\newpage
\theendnotes
